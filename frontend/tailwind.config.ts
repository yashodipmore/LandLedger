  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "grid-pattern-subtle": "linear-gradient(rgba(148, 163, 184, 0.02) 1px, transparent 1px), linear-gradient(90deg, rgba(148, 163, 184, 0.02) 1px, transparent 1px)",
      },
      backgroundSize: {
        "grid": "40px 40px",
        "grid-subtle": "20px 20px",
      },
      boxShadow: {
        ...
        "professional-2xl": "0 25px 50px -12px rgb(0 0 0 / 0.25)",
        "glow": "0 0 20px rgb(59 130 246 / 0.3)",
        "glow-lg": "0 0 30px rgb(59 130 246 / 0.4)",
      },
      dropShadow: {
        "glow": "0 0 10px rgb(59 130 246 / 0.6)",
        "glow-lg": "0 0 20px rgb(59 130 246 / 0.8)",
      },
      backdropBlur: {
        "professional": "16px",
      },
